...
class SpectranetSubPage extends StatefulWidget {
  const SpectranetSubPage({Key? key}) : super(key: key);

  @override
  _SpectranetSubPageState createState() => _SpectranetSubPageState();
}

class _SpectranetSubPageState extends State<SpectranetSubPage> {
  String? pin;
  @override
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Account ID',style: TextStyle(fontSize: 12.5.sp),),
                Container(
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration:   InputDecoration.collapsed(
                                  hintText:  'Enter 15 digit account ID',
                    ...
                    child:Row(children: [
                      ...
                      Expanded(
                        child: TextField(
                            ...
                            style: TextStyle(fontSize: 15.sp),
                            decoration:   InputDecoration.collapsed(
                                hintText: 'No Package Selected yet',
                                hintStyle:  TextStyle(fontSize: 15.sp,
                                    color: kBlack1
                                ))),
                      ),
