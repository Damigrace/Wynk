...
//   const Startimes({Key? key}) : super(key: key);
//
//   @override
...
//                         Text('Startimes',style: TextStyle(fontSize: 26.sp),),
//                       ],
//                     ),
//                     SizedBox(
//                         width: 62.w,
...
//                                 hintText: 'Family Bouquet(3 Months)',
...
//                     )
//                 ),
//                 Text('Card Number/User ID',style: TextStyle(fontSize: 12.5.sp),),
//                 Container(
...
//                               style: TextStyle(fontSize: 15.sp,),
//                               decoration:   InputDecoration.collapsed(
//                                   hintText:  'Enter 10 digit card number/User ID',
//                                   hintStyle:  TextStyle(fontSize: 15.sp,
//                                       color: kBlack1
//                                   )),),
//                           ),
