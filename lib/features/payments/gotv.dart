            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    ...
                    child:Row(children: [
                      SizedBox(width: 10.w,),
                      Image.asset('lib/assets/images/gotv.png',height: 30.w,width: 30.w,),
                      SizedBox(width: 10.w,),
                      Expanded(
                        child: TextField(
                      ...
                      GestureDetector(
                          onTap: ()async{
                            spinner(context);
                            List <TvCard> cards = [];
                            final res = await multiChoiceLookup('GOTV');
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onChanged: (val)async{
                              if(val.length == 10){
                                spinner(context);
                                final res = await multichoiceValidate('GOTV', smartCardCont.text);
