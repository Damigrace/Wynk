...
//
//   @override
//   _TotalGasState createState() => _TotalGasState();
// }
//
// class _TotalGasState extends State<TotalGas> {
//   String? pin;
//   @override
...
//                         Text('Total Gas',style: TextStyle(fontSize: 26.sp),),
//                       ],
//                     ),
//                     SizedBox(
//                         width: 62.w,
...
//                 Text('Select  Size',style: TextStyle(fontSize: 12.5.sp),),
//                 Container(
...
//                     )
//                 ),
//                 Text('Customer ID',style: TextStyle(fontSize: 12.5.sp),),
//                 Container(
...
//                               style: TextStyle(fontSize: 15.sp,),
//                               decoration:   InputDecoration.collapsed(
//                                   hintText:  'Enter 10 digit Customer ID',
//                                   hintStyle:  TextStyle(fontSize: 15.sp,
//                                       color: kBlack1
//                                   )),),
//                           ),
...
//                     )
//                 ),
//                 Text('Location',style: TextStyle(fontSize: 12.5.sp),),
//                 Container(
//                     margin: EdgeInsets.only(bottom: 22.h,top: 14.h),
//                     padding: EdgeInsets.symmetric(horizontal: 12.w),
//                     height: 61.h,
//                     width: 318.w,
//                     decoration:  BoxDecoration(
...
//                     )
//                 ),
//                 Text('State',style: TextStyle(fontSize: 12.5.sp),),
//                 Container(
//                     margin: EdgeInsets.only(top: 14.h,bottom: 27.h),
//                     height: 61.h,
//                     width: double.infinity,
